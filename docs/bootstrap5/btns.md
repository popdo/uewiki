...
<button type="button" class="btn btn-info" data-toggle="button" autocomplete="off">Toggle button</button>
<button type="button" class="btn btn-info active" data-toggle="button" autocomplete="off" aria-pressed="true">Active toggle button</button>
<button type="button" class="btn btn-info" disabled data-toggle="button" autocomplete="off">Disabled toggle button</button>
```
...
使用`.o-pill`工具可以给元素快速添加椭圆效果，不仅仅适用于按钮。

```demo
<button type="button" class="btn btn-primary o-pill">Primary</button>
<button type="button" class="btn btn-secondary o-pill">Secondary</button>
<button type="button" class="btn btn-outline-success o-pill">Success</button>
<button type="button" class="btn btn-danger o-pill">Danger</button>
<button type="button" class="btn btn-warning o-pill">Warning</button>
<button type="button" class="btn btn-info o-pill">Info</button>
<button type="button" class="btn btn-dark o-pill">Dark</button>
```

```html
<button type="button" class="btn btn-primary o-pill">Primary</button>
<button type="button" class="btn btn-secondary o-pill">Secondary</button>
<button type="button" class="btn btn-success o-pill">Success</button>
<button type="button" class="btn btn-danger o-pill">Danger</button>
<button type="button" class="btn btn-warning o-pill">Warning</button>
<button type="button" class="btn btn-info o-pill">Info</button>
<button type="button" class="btn btn-dark o-pill">Dark</button>
...
<div class="is-group" role="group" aria-label="Basic example">
  <button type="button" class="item btn btn-primary">Left</button>
  <button type="button" class="item btn btn-primary">Middle</button>
  <button type="button" class="item btn btn-primary">Right</button>
</div>
<div class="is-group" role="group" aria-label="Basic outlined example">
  <button type="button" class="item btn btn-outline-primary">Left</button>
  <button type="button" class="item btn btn-outline-primary">Middle</button>
  <button type="button" class="item btn btn-outline-primary">Right</button>
</div>
<div class="is-group">
  <a href="#" class="item btn btn-primary active" aria-current="page">Active link</a>
  <a href="#" class="item btn btn-primary">Link</a>
  <a href="#" class="item btn btn-primary">Link</a>
</div>
<hr>
<p><code>.btn-group</code></p>
...
```demo
<p><code>.is-group</code> btn-check的label上添加<code>.check-label</code></p>
<div class="is-group mb-1" role="group" aria-label="Basic checkbox toggle button group">
  <input type="checkbox" class="btn-check" id="isbtncheck1" autocomplete="off">
  <label class="btn btn-outline-primary check-label" for="isbtncheck1">Checkbox 1</label>
  <input type="checkbox" class="btn-check" id="isbtncheck2" autocomplete="off">
  <label class="btn btn-outline-primary check-label" for="isbtncheck2">Checkbox 2</label>
  <input type="checkbox" class="btn-check" id="isbtncheck3" autocomplete="off">
  <label class="btn btn-outline-primary check-label" for="isbtncheck3">Checkbox 3</label>
</div>
<div class="is-group mb-1" role="group" aria-label="Basic radio toggle button group">
  <input type="radio" class="btn-check" name="isbtnradio" id="isbtnradio1" autocomplete="off" checked>
  <label class="btn btn-outline-primary check-label" for="isbtnradio1">Radio 1</label>

  <input type="radio" class="btn-check" name="isbtnradio" id="isbtnradio2" autocomplete="off">
  <label class="btn btn-outline-primary check-label" for="isbtnradio2">Radio 2</label>

  <input type="radio" class="btn-check" name="isbtnradio" id="isbtnradio3" autocomplete="off">
  <label class="btn btn-outline-primary check-label" for="isbtnradio3">Radio 3</label>
</div>
...
```demo
<p><code>.is-group</code></p>
<div class="is-group mb-2" role="group" aria-label="Button group with nested dropdown">
  <button type="button" class="btn btn-primary">1</button>
  <button type="button" class="btn btn-primary">2</button>
  <div class="is-group" role="group">
...
```demo
<p><code>.is-boxes</code></p>
<div class="is-boxes" role="group" aria-label="Vertical button group">
    <button type="button" class="btn btn-secondary">Button</button>
    <button type="button" class="btn btn-secondary">Button</button>
    <div class="is-boxes" role="group">
      ...
      <ul class="dropdown-menu d-none" aria-labelledby="btnGroupVerticalDrop1" style="">
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
      </ul>
    </div>
    ...
    <div class="is-boxes" role="group">
      ...
      <ul class="dropdown-menu d-none" aria-labelledby="btnGroupVerticalDrop4">
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
      </ul>
    </div>
...
<div class="btn-group-vertical" role="group" aria-label="Vertical button group">
    ...
    <div class="btn-group" role="group">
      ...
      <ul class="dropdown-menu" aria-labelledby="btnGroupVerticalDrop1" style="">
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
        <li><a class="dropdown-item" href="#">Dropdown link</a></li>
      </ul>
    </div>
