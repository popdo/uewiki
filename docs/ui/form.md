...
```demo
<input class="form-item is-sm mb-1" type="text" placeholder="Small input">
...
```demo
<div class="field-bd">
    <input class="is-file" type="file" name="file_1" id="file_1"><label class="is-group" for="file_1"><span class="item btn btn-success"><i class="icon">&#xe601;</i>点击上传...</span><span class="item btn btn-default btn-file">Screen Shot 2019-07-29 at 15.54.25.png</span></label>
</div>
```
...
<div class="field-bd">
    ...
    <label class="is-group" for="file_1">
        ...
        <!-- 路径过长在移动端会超出容器，因此添加btn-file -->
        <span class="item btn btn-default btn-file">
...
结合`is-boxes`制作更多样式的文件框

```demo
<div class="row">
    <div class="field-bd col-sm-6">
        <input class="is-file" type="file" name="file_1" id="file_1">
        <label class="is-boxes" for="file_1">
...
<div class="row">
    <div class="field-bd col-sm-6">
<input class="is-file" type="file" name="file_1" id="file_1"><label class="is-boxes" for="file_1"><span class="item btn btn-warning box-hd" style="height:160px"><i class="icon ico-upload">&#xe601;</i>点击上传...</span><span class="item btn btn-default btn-file">Screen Shot 2019-07-29 at 15.54.25.png</span></label>
    </div>
    <div class="field-bd col-sm-6">
<input class="is-file is-pic-file" type="file" name="facePic" id="facePic"><label class="is-boxes" for="facePic"><span class="item btn box-hd is-mask" id="showPic" style="background-image: url(ui/images/img3.jpg);height:160px"><i class="icon ico-upload">&#xe601;</i>点击上传...</span><span class="item btn btn-default btn-file">Screen Shot 2019-07-29 at 15.54.25.png</span></label>
    </div>
</div>
```
...
<div class="field-bd">
    ...
    <label class="is-boxes" for="facePic">
        <!-- 通过is-mask和背景图制作遮罩的效果 -->
        <span class="item btn box-hd is-mask" id="showPic" style="background-image: url(ui/images/ss1.jpg);height:160px">
...
<form class="">
    <div class="field">
        <label class="form-label" for="f1">普通</label>
        <div class="field-bd">
            <div class="has-tip">
                <input type="text" class="form-item" name="" id="f1" placeholder="提示文字">
                <small class="form-text">显示这里的文字上层嵌套一层`.has-tip`即可</small></div>
        </div>
    </div>
    <hr>
    <div class="field">
        <label class="form-label" for="f1">group普通</label>
        <div class="field-bd is-group">
            <label class="item item-text">性别</label>
            <input class="item form-item w-auto" type="text" name="" id="f1">
            <button class="item btn btn-primary" type="button">提交</button></div>
    </div>
    <div class="field">
        <label class="form-label" for="f1">group全屏</label>
        <div class="field-bd is-group">
            <input class="item form-item" type="text" name="" id="f1">
            <button class="item btn btn-info" type="button">提交</button></div>
    </div>
    <hr>
    <div class="field">
        <label class="form-label" for="f1">内联</label>
        <div class="field-bd">
            <div class="d-flex">
                <input type="text" class="form-item" name="" id="">
                <label class="the-label">走起来</label>
                <div class="has-tip">
                    <input type="text" class="form-item" name="" id="f1">
                    <small class="form-text">显示这里的文字上层嵌套一层`.has-tip`即可</small></div>
            </div>
        </div>
    </div>
    <hr>
    <div class="field">
        <label class="form-label" for="f1">禁用</label>
        <div class="field-bd">
            <input type="text" class="form-item w-100" name="" id="" value="bme@qq.com" disabled="disabled"></div>
    </div>
    <hr>
    <div class="field">
        ...
        <div class="field-bd">
            <div class="select">
                <select class="form-item">
                    <option>Business development</option>
                    <option>Marketing</option>
                    <option>Sales</option></select>
            </div>
        </div>
    </div>
    <hr>
    <div class="field">
        <label class="form-label">内联单选</label>
        <div class="field-bd">
            <input class="is-radio" type="radio" name="x_1" id="x_1_1" checked="checked">
            <label for="x_1_1">Yes</label>
            <input class="is-radio" type="radio" name="x_1" id="x_1_2">
            <label for="x_1_2">No</label>
            <input class="is-radio" type="radio" name="x_1" id="x_1_3" disabled="disabled">
            <label for="x_1_3">disabled</label></div>
    </div>
    <div class="field">
        <label class="form-label">内联多选</label>
        <div class="field-bd">
            <input class="is-checkbox" id="x_2_1" type="checkbox" name="x_2" checked="checked">
            <label for="x_2_1">op1</label>
            <input class="is-checkbox" id="x_2_2" type="checkbox" name="x_2">
            <label for="x_2_2">op2</label>
            <input class="is-checkbox" id="x_2_3" type="checkbox" name="x_2" checked="checked" disabled="disabled">
            <label for="x_2_3">checkbox</label></div>
    </div>
    <hr>
    <div class="field">
        ...
        <div class="field-bd">
            ...
            <label class="is-group" for="file_1">
                <span class="item btn btn-danger">
                    <i class="icon">&#xe601;</i>点击上传...</span>
                <span class="item btn btn-default btn-file">Screen Shot 2019-07-29 at 15.54.25.png</span></label>
        </div>
    </div>
    <hr>
    <div class="field">
    ...
    <div class="field">
        <div class="field-bd">
            <button class="btn btn-primary">点击提交</button></div>
    </div>
</form>
```
...
<form method="get" class="">
    <div class="field">
        <label class="form-label" for="f1">说明</label>
        <div class="field-bd">
            <!-- code... -->
        </div>
    </div>
...
<form class="">
    ...
    <div class="field">
        <label class="form-label" for="f1">内联</label>
        <div class="row row-cols-md-auto align-items-center flex-y-center">
            <div class="col-12">
                <input class="form-item" type="text" name="" id="">
            </div>
            <label class="col-12">走起来</label>
            <div class="col-12 has-tip">
                <input class="form-item" type="text" name="" id="f1">
                <small class="form-text">显示这里的文字上层嵌套一层`.has-tip`即可</small>
            </div>
        </div>
    </div>
    <hr>
...
<form class="x-form">
    <div class="field">
        <label class="x-label" for="f1">普通</label>
        <div class="field-bd">
            <div class="has-tip">
                <input type="text" class="form-item" name="" id="f1" placeholder="提示文字">
                <small class="form-text">显示这里的文字上层嵌套一层`.has-tip`即可</small></div>
    ...
    <hr>
    <div class="field">
        <label class="x-label" for="f1">group普通</label>
        <div class="field-bd is-group">
            <label class="item item-text">性别</label>
            <input class="item form-item w-auto" type="text" name="" id="f1">
            <button class="item btn btn-primary" type="button">提交</button></div>
    ...
    <div class="field">
        <label class="x-label" for="f1">group全屏</label>
        <div class="field-bd is-group">
            <input class="item form-item" type="text" name="" id="f1">
            <button class="item btn btn-info" type="button">提交</button></div>
    </div>
    <hr>
    <div class="field">
        <label class="x-label" for="f1">内联</label>
        <div class="field-bd">
            <div class="d-flex">
                <input type="text" class="form-item" name="" id="">
                <label class="the-label">走起来</label>
    ...
    <hr>
    <div class="field">
        <label class="x-label" for="f1">禁用</label>
        <div class="field-bd">
            <input type="text" class="form-item w-100" name="" id="" value="bme@qq.com" disabled="disabled"></div>
    </div>
    <hr>
    <div class="field">
        <label class="x-label">下拉菜单</label>
        <div class="field-bd">
            <div class="select">
                <select class="form-item">
                    <option>Business development</option>
    ...
    <hr>
    <div class="field">
        <label class="x-label">内联单选</label>
        <div class="field-bd">
            <input class="is-radio" type="radio" name="x_1" id="x_1_1" checked="checked">
            <label for="x_1_1">Yes</label>
            <input class="is-radio" type="radio" name="x_1" id="x_1_2">
    ...
    <div class="field">
        <label class="x-label">内联多选</label>
        <div class="field-bd">
            <input class="is-checkbox" id="x_2_1" type="checkbox" name="x_2" checked="checked">
            <label for="x_2_1">op1</label>
            <input class="is-checkbox" id="x_2_2" type="checkbox" name="x_2">
...
<form method="post" class="in-form bo p-3"><div class="field is-group"><div class="is-group"><label class="item item-text" for="">普通</label><input class="item form-item is-auto" type="text" name="" placeholder="提示文字"></div><small class="form-text flex-1-0-auto">Do not enter the first zero</small></div><hr><div class="field is-group"><label class="item item-text" for="">group普通</label><input class="item form-item w-auto" type="text" name=""> <button class="item btn is-primary" type="button">提交</button></div><div class="field is-group"><label class="item item-text" for="">group全屏</label><input class="item form-item" type="text" name=""> <button class="item btn is-info" type="button">提交</button></div><hr><div class="field"><div class="is-group"><label class="item item-text" for="">group1</label><input type="text" class="item form-item" name=""></div><div class="is-group"><label class="item item-text" for="">group2</label><input type="text" class="item form-item" name=""></div></div><div class="field"><div class="is-group"><label class="item item-text" for="">label1</label><input type="text" class="item form-item" name=""><label class="item item-text" for="">label2</label><input type="date" class="item form-item" name=""></div></div><hr><div class="field is-group select"><label class="item item-text">下拉菜单</label><select class="item form-item"><option>Business development</option><option>Marketing</option><option>Sales</option></select></div><hr><div class="field is-group"><label class="item item-text">内联单选</label><div class="item form-item"><input class="is-radio" type="radio" name="a_1" id="a_1_1" checked="checked"><label for="a_1_1">Yes</label><input class="is-radio" type="radio" name="a_1" id="a_1_2"><label for="a_1_2">No</label><input class="is-radio" type="radio" name="a_1" id="a_1_3" disabled="disabled"><label for="a_1_3">disabled</label></div></div><div class="field is-group"><label class="item item-text">内联多选</label><div class="item form-item"><input class="is-checkbox" id="b_2_1" type="checkbox" name="b_2" checked="checked"><label for="b_2_1">op1</label><input class="is-checkbox" id="b_2_2" type="checkbox" name="b_2"><label for="b_2_2">op2</label><input class="is-checkbox" id="b_2_3" type="checkbox" name="b_2" checked="checked" disabled="disabled"><label for="x_2_3">checkbox</label></div></div><hr><div class="field is-group"><label class="item item-text">开关</label><div class="item form-item"><input class="is-switch is-success" id="t3_1" type="checkbox" name="" checked="checked"><label for="t3_1"><span class="ico" data-tip="已关闭"><i>已开启</i></span> 评论审核</label></div></div><hr><div class="field"><div class="field-bd"><input class="is-file" type="file" name="file-d1" id="file-d1"><label class="is-group" for="file-d1"><span class="item btn is-link"><i class="icon">&#xe601;</i> 点击上传...</span> <span class="item btn is-default">Screen Shot 2019-07-29 at 15.54.25.png</span></label></div></div><hr><div class="field"><textarea class="form-item" placeholder="Explain how we can form-text you"></textarea></div><div class="field"><button class="btn is-primary">Send message</button></div></form>


```html
<form method="post" class="in-form">
    <div class="field is-group">
        <label class="item item-text" for="">说明</label>
